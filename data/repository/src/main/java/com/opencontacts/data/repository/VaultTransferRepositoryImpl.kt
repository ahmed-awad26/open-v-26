...
private fun ContactSummary.toJson(): JSONObject = JSONObject().apply { put("id", id); put("displayName", displayName); put("primaryPhone", primaryPhone); put("tags", JSONArray(tags)); put("isFavorite", isFavorite); put("folderName", folderName); put("photoUri", photoUri); put("isBlocked", isBlocked) }
